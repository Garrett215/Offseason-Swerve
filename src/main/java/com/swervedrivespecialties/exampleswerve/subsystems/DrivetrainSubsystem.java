...
public class DrivetrainSubsystem extends Subsystem {
    ...
    private static final double FRONT_LEFT_ANGLE_OFFSET = -Math.toRadians(0.3);
    private static final double FRONT_RIGHT_ANGLE_OFFSET = -Math.toRadians(0.25);
    private static final double BACK_LEFT_ANGLE_OFFSET = -Math.toRadians(230.5);
    private static final double BACK_RIGHT_ANGLE_OFFSET = -Math.toRadians(253.5);
